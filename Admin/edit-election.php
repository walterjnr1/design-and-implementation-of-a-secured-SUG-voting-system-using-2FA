...
{
$election=$_POST['txtelection'];


$sql = " update election set election_name='$election' where ID='$id'";
             ...
             <form  action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                   <div class="form-group">
                                                ...
                                                <input id="userName" name="txtelection" type="text" size="77" value="<?php echo $row['election_name'];?>" class="form-control required">
                                            </div>
