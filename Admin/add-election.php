...
$election = mysqli_real_escape_string($conn,$_POST['txtelection']);

 $sql = "SELECT * FROM election where election_name='$election'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
$_SESSION['error'] =' Election Type already Exist ';

}else{
//save election  details
$query = "INSERT into `election` (election_name)
VALUES ('$election')";
...
$_SESSION['success'] = "Election Created Successfully";
  ...
  $_SESSION['error'] = "Problem Creating Election Details";
}
}
}
?>
               ...
               <form id="form" action="" method="post" class="">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtelection" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtelection']))?><?php echo $_POST['txtelection']; ?>" placeholder="Enter Election Name">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" name="btncreate" class="btn btn-primary">Create Election</button>
                </div>
              </form>
            </div>
