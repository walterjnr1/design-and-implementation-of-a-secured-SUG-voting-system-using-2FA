...
<head>
  ...
  <title>Votes Record|Admin Dashboard</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Votes Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                  ...
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%"><div align="center">#</div></th>
                        <th width="13%"><div align="center">Candidate ID</div></th>
						<th width="7%"><div align="center">Candidate Name</div></th>
                        <th width="7%"><div align="center">Voter ID</div></th>
                        <th width="7%"><div align="center">Voter Name</div></th>
						 <th width="8%"><div align="center">Vote Date</div></th>
                        <th width="8%"><div align="center">Office</div></th>
                      </tr>
                    </thead>
                    <tbody>
                							      <?php
                                          $sql = "SELECT * FROM voting order by voteTime ASC";
                                           $result = $conn->query($sql);
										$cnt=1;
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['voteTime']; ?></div></td>
