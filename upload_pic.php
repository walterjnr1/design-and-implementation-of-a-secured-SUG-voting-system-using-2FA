...
$image= addslashes(file_get_contents($_FILES['image']['tmp_name']));
 ...
 $sql = " update voter set photo='$location' where regNo='".$_SESSION['regNo']."'";
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <title>Upload Voter Image</title>
  ...
  <div id="wrapper">
    ...
    <p align="center"><form  method="post"  enctype="multipart/form-data">
                  <table width="505" border="0" align="center">
                    <tr>
                      <th width="499" scope="col"><div align="center"><span class="style12">VOTER'S PHOTO </span>&nbsp;</div></th>
                    </tr>
                    <tr>
...
$sql = "select * from voter where regNo ='".$_SESSION['regNo']."'"; 
$result = $conn->query($sql);
$row = mysqli_fetch_array($result);
                        ...
                        <tr>
                          <td><p align="center">&nbsp;</p>
                            <p align="center"><strong><span class="style30"> <span class="style31">VOTER NAME</span>:</span> <?php echo " <strong><font face='Verdana' size='3' color=blue>".$rowaccess['voterName']." </font></strong>";  ?></strong></p>
                        ...
                        <tr>
                          <td><p align="center"><strong><span class="style32">VOTER ID </span>: <?php echo " <strong><font face='Verdana' size='3' color=blue>".$rowaccess['voterID']." </font></strong>";  ?></strong></p>                          </td>
                        </tr>
                        <tr>
                          <td height="40">
