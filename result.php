...
echo "<a href='logout.php'>Logout</a>"	;	
  ...
  <div id="wrapper">
    ...
    <p align="center"><strong>REALTIME ELECTION RESULT </strong></p>
    <table width="52%" border="1" align="center" class="table table-bordered table-striped" id="resultTable">
      <thead>
        <tr>
          <th width="3%" bordercolor="#000000" bgcolor="#999999" class="style36"><div align="center" class="style40">#</div></th>
          <th width="29%" bordercolor="#000000" bgcolor="#999999" class="style36"><div align="center" class="style40">Candidate</div></th>
          <th width="20%" bordercolor="#000000" bgcolor="#999999" class="style36"><div align="center" class="style40">Position</div></th>
          <th width="19%" bordercolor="#000000" bgcolor="#999999" class="style36"><div align="center" class="style40">Count</div></th>
		            <th width="19%" bordercolor="#000000" bgcolor="#999999" class="style36"><div align="center" class="style40">Percentage</div></th>

        </tr>
      </thead>
      <tbody>
        <?php 
                                          $sql = "SELECT * FROM candidate where post='".$_SESSION['Epost']."' order by count ASC";
        ...
        <tr class="gradeX">
          <td height="47"><div align="center" class="style38 style41">
              <div align="center"><?php echo $cnt; ?></div>
								 ...
								 <td><div align="center" class="style2"><strong><?php echo $_SESSION["Epost"]; ?></strong></div></td>
